...
//             DebugUtility.HandleErrorIfNullFindObject<EnemyManager, DrifterController>(m_EnemyManager, this);

//             m_ActorsManager = FindObjectOfType<ActorsManager>();
//             DebugUtility.HandleErrorIfNullFindObject<ActorsManager, DrifterController>(m_ActorsManager, this);

//             m_EnemyManager.RegisterEnemy(this);

//             m_Health = GetComponent<Health>();
//             DebugUtility.HandleErrorIfNullGetComponent<Health, DrifterController>(m_Health, this, gameObject);

//             m_Actor = GetComponent<Actor>();
//             DebugUtility.HandleErrorIfNullGetComponent<Actor, DrifterController>(m_Actor, this, gameObject);

//             NavMeshAgent = GetComponent<NavMeshAgent>();
//             m_SelfColliders = GetComponentsInChildren<Collider>();

//             m_GameFlowManager = FindObjectOfType<GameFlowManager>();
//             DebugUtility.HandleErrorIfNullFindObject<GameFlowManager, DrifterController>(m_GameFlowManager, this);
...
//             DebugUtility.HandleErrorIfNoComponentFound<DetectionModule, DrifterController>(detectionModules.Length, this,
//                 gameObject);
//             DebugUtility.HandleWarningIfDuplicateObjects<DetectionModule, DrifterController>(detectionModules.Length,
//                 this, gameObject);
...
//             if (damageSource && !damageSource.GetComponent<DrifterController>())
//             {
//                 // pursue the player
...
//                 DebugUtility.HandleErrorIfNoComponentFound<WeaponController, DrifterController>(m_Weapons.Length, this,
//                     gameObject);
...
//             DebugUtility.HandleErrorIfNullGetComponent<WeaponController, DrifterController>(m_CurrentWeapon, this,
//                 gameObject);
